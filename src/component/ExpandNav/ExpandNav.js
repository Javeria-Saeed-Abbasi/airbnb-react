...
import MapImage1 from "../../component/assets/images/mapImg2.jpg";
import MapImage2 from "../../component/assets/images/mapImg.webp";
import MapImage3 from "../../component/assets/images/mapImg3.webp";
import MapImage4 from "../../component/assets/images/mapImg4.webp";
  ...
  return (
    <div className="expand-nav">
      <Navbar
        bg="light"
        expand="lg"
        className="px-5 py-3 Header wow fadeIn center"
        data-wow-delay="1.3s"
        id="navbar-fixed-top"
      >
        <>
 ...
 <Button variant="" className="searchBtn2"><FaSearch/></Button>
      ...
      <div className="modal3">
        <Modal
          ...
          dialogClassName="modal-90w modal3"
          aria-labelledby="example-custom-modal-styling-title"
        >
          <Container>
            <Modal.Body>
              <div id="modal3 modal3-content" className="counter-modal-content">
                  ...
                  <Row className="">
                    <Col className="" lg={6}>
                      <div className="text-start">
                        <span className="h-1">Adults</span>
                        <p className="p1">Ages 13 or above</p>
                      </div>
                    </Col>
                    <Col lg={6}>
                ...
                <div className="">
                  <Row className="">
                    <Col className="" lg={6}>
                      <div className="text-start">
                        <span className="h-1">Children</span>
                        <p className="p1">Ages 2–12</p>
                      </div>
                    </Col>
                    <Col lg={6}>
                      <div className="text-end">
                ...
                <div className="">
                  <Row className="">
                    <Col className="" lg={6}>
                      <div className="text-start">
                        <span className="h-1">Infants</span>
                        <p className="p1">Under 2</p>
                      </div>
                    </Col>
                    <Col lg={6}>
                      <div className="text-end">
